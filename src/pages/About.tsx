  ...
  return (
    <div className="min-h-screen bg-dark pt-20 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-8">About NexusNotes</h1>
        <div className="space-y-6 text-white/80">
          <p>
            NexusNotes is a revolutionary educational platform designed specifically for college students, 
          ...
          <p>
            Born from the understanding that modern education requires modern solutions, NexusNotes 
          ...
          <p>
            ...
            NexusNotes provides an intuitive platform to enhance your academic journey.
          </p>
        </div>
      </div>
    </div>
