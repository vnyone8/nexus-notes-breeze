      ...
      <div className="h-full px-6 md:px-8 mx-auto flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <Link to="/" className="text-2xl md:text-3xl font-bold animate-fade-in transition-all duration-300">
            <span className="bg-gradient-to-r from-[#4b0082] via-[#8a2be2] to-[#e0b0ff] bg-clip-text text-transparent hover:drop-shadow-[0_0_10px_rgba(139,92,246,0.5)] transition-all duration-300">
              PurpleNotes
            </span>
          </Link>
        </div>
